...
namespace CPE200Lab1
{
    ...
    {
        public string calculate2(string operate, string firstOperand)
        {
            string ans;
            switch (operate)
            {
        ...
        string prev_operate;
        public string calculate(string operate, string firstOperand, string secondOperand=null, int maxOutputSize = 8)
        {
            switch (operate)
            {
                case "+":
